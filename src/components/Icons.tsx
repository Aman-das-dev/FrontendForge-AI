...
export const ArrowPathIcon = ({ className, size = 24, ...props }: IconProps) => (
...
export const ArrowTrendingUpIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ChartPieIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ChevronLeftIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    ...
    {...props}
  >
    <path d="m15.75 19.5l-7.5-7.5l7.5-7.5" />
  </svg>
);
...
export const Cog8ToothIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Cube16SolidIcon = ({ className, size = 16, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const XMarkIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ChevronUpSolidIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const LinkSolidIcon = ({ className, size = 24, ...props }: IconProps) => (
  <svg aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
